...
Devise.setup do |config|
  ...
  # config.secret_key = 'c43fb988b8a5cd9119a76ad5da9beb20a8f000\
  # 21d81d884b1be7b90885dbb9d1ddc4d930c849c3fc89e70f12c4a9d737b1\
  # 0fdf4a45e8dc644e38b8b8aacc4e3a'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'automation-mailer@example.com'
  ...
  # config.pepper = 'ee4dcc044f6d5d270811dddceb5ac28982\
  # ffea25b463b5ab754d75d5fa8c58ba0a3fbc0a1e2297ec3186fa\
  # 667431339e251a28d4e1dd0583556c5b4312ccc98a'
  ...
  config.omniauth :github,
    Rails.application.secrets.oauth2.github.app_id,
    Rails.application.secrets.oauth2.github.app_secret,
    scope: 'user'
  config.omniauth :google_oauth2,
    Rails.application.secrets.oauth2.google.client_id,
    Rails.application.secrets.oauth2.google.client_secret
